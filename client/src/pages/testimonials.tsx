...
const testimonials = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1494790108755-2616b45bb442?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=200&h=200',
    rating: 5,
...
export default function Testimonials() {
  ...
  const { ref: testimonialsRef, hasIntersected: testimonialsIntersected } = useIntersectionObserver();
      ...
      <section className="pt-24 pb-20 gradient-bg">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div ref={heroRef} className={`text-center reveal ${heroIntersected ? 'active' : ''}`}>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 text-gradient">Client Reviews</h1>
            <p className="text-xl text-neutral-custom max-w-3xl mx-auto leading-relaxed">
              Hear from our satisfied clients about their experience working with First Interior
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                thumbnail: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
              },
              {
                name: 'Michael Chen',
                project: 'Office Design',
                thumbnail: 'https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
              },
              {
                name: 'Emily Rodriguez',
                project: 'Restaurant Design',
                thumbnail: 'https://images.unsplash.com/photo-1554118811-1e0d58224f24?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
              },
            ].map((video, index) => (
              <div
                key={video.name}
