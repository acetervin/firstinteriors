...
const portfolioItems = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1631679706909-1844bbd07221?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
  },
  {
    id: 3,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1560185007-cde436f6a4d0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
  },
  {
    id: 5,
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1507089947368-19c1da9775ae?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=600&h=400',
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div ref={ref} className={`text-center mb-16 reveal ${hasIntersected ? 'active' : ''}`}>
          ...
          <p className="text-xl text-neutral-custom max-w-3xl mx-auto">
            Explore our portfolio of stunning interiors that showcase our commitment to excellence
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {portfolioItems.map((item, index) => (
            <div
              key={item.id}
              className={`portfolio-item rounded-2xl overflow-hidden shadow-lg reveal ${hasIntersected ? 'active' : ''}`}
            ...
            >
              ...
              <div className="p-6 bg-white">
                <h3 className="text-xl font-semibold mb-2 text-primary-custom">{item.title}</h3>
                <p className="text-neutral-custom">{item.description}</p>
              </div>
            </div>
          ))}
        </div>

        <div className={`text-center mt-12 reveal ${hasIntersected ? 'active' : ''}`}>
