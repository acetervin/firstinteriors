      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div ref={ref} className={`reveal ${hasIntersected ? 'active' : ''}`}>
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gradient">About First Interior</h2>
            ...
            <p className="text-lg text-neutral-custom mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-accent-custom mb-2">200+</div>
                <div className="text-sm text-neutral-custom uppercase tracking-wide">Projects Completed</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold text-accent-custom mb-2">15+</div>
